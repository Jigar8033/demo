...
const Troubleshooting = () => {
  ...
  useEffect(() => {
    // Fetch the requisition data by ID
    axios
      .get(`https://localhost:7280/api/Requisitionentry/${id}`)
      .then((response) => {
        if (response.data) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
  .put(`https://localhost:7280/api/Requisitionentry/${id}`, formData[0])
  .then(() => {
              ...
              <div className="row">
                <div className="col-12">
                  <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h2 className="mb-sm-0">Requisition Entry Form</h2>
                  </div>
                </div>
              </div>
                      ...
                      <div className="col-md-4 mb-3">
                        ...
                        >
                          ...
                          {initiatorNames.map((initiator) => (
                            <option key={initiator.PersonID} value={initiator.LoginID}>
                              {initiator.LoginID}
                            </option>
                          ))}
                ...
                <tbody>
                  {formData.map((data, index) => (                   
                    <tr key={`${index}-${data.itemName}` }> {/* Ensure uniqueness by combining index with another unique field */}
                      ...
                      <td>
                        <a href="javascript:void(0);" className="link-success" onClick={() => handleDelete(data.index)}>
